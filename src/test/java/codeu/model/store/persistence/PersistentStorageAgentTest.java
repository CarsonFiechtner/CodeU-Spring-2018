...
public class PersistentStorageAgentTest {
  ...
  @Test
  public void testLoadSourceTexts() throws PersistentDataStoreException {
    persistentStorageAgent.loadSourceTexts();
    Mockito.verify(mockPersistentDataStore).loadSourceTexts();
  }
  ...
  @Test
  public void testWriteThroughSourceText() {
    SourceText source =
